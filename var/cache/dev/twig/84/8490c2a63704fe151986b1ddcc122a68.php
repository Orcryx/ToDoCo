...
\t\t\t\t";
            // line 11
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11), "userIdentifier", [], "any", false, false, false, 11), "html", null, true);
            yield ",
\t\t\t\t<a href=\"";
            // line 12
...
";
    ...
    {
        return array (  114 => 20,  108 => 17,  104 => 15,  98 => 12,  94 => 11,  90 => 9,  87 => 8,  81 => 6,  79 => 5,  76 => 4,  63 => 3,  40 => 1,);
    }
