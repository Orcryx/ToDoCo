...
class __TwigTemplate_245ee85c737b2478eb8b715b36b72960 extends Template
{
    ...
    public function block_header_title(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "\t<h1>Bienvenue sur Todo List, l'application vous permettant de gérer l'ensemble de vos tâches sans effort !</h1>
";
...
\t\t\t<a href=\"";
            ...
            yield "\" class=\"btn btn-success\">Créer une nouvelle tâche</a>
\t\t\t<a href=\"";
            // line 11
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_task_list");
            yield "\" class=\"btn btn-primary\">Consulter la liste des tâches à faire</a>
\t\t\t<a href=\"\" class=\"btn btn-info\">Consulter la liste des tâches terminées</a>
\t\t\t";
            // line 13
            if (CoreExtension::inFilter("ROLE_ADMIN", CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), "roles", [], "any", false, false, false, 13))) {
                ...
                yield "\" class=\"btn btn-danger\">Accès admin</a>
\t\t\t";
            }
            // line 16
            yield "\t\t</div>
\t";
    ...
    {
        return array (  125 => 16,  119 => 14,  117 => 13,  112 => 11,  108 => 10,  105 => 9,  102 => 8,  89 => 7,  77 => 4,  64 => 3,  41 => 1,);
    }
...
\t\t\t<a href=\"{{ path('user_task_list') }}\" class=\"btn btn-primary\">Consulter la liste des tâches à faire</a>
\t\t\t<a href=\"\" class=\"btn btn-info\">Consulter la liste des tâches terminées</a>
\t\t\t{% if 'ROLE_ADMIN' in app.user.roles %}
\t\t\t\t<a href=\"{{ path('app_admin') }}\" class=\"btn btn-danger\">Accès admin</a>
\t\t\t{% endif %}
\t\t</div>
\t{% endif %}
{% endblock %}
", "home/index.html.twig", "/home/orcryx/Bureau/OpenClassRooms/ToDoCo/templates/home/index.html.twig");
    }
}
